<template>
  <v-app>
    ...
    <Loading v-if="$store.state.loding" />
...
<script>
import SirBase   from "./components/SirBase"
...
<style lang="scss"> 
/*@import url("./scss/sirAdmin.scss");*/
/*@import url("./scss/Admin.scss");*/
...
/*
textarea, input[type=text], input[type=password]{ -webkit-appearance:none;border-color: #d9d9d9;}
...
@mixin responde-pk01($device) {
  ...
  .U_{
      ...
      &maskbox{width:100%;height:100%;background:rgba(0,0,0,0.8)}
